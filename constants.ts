...
export const WAREHOUSE_HEADER_COLORS: Record<string, { border: string; sub: string; }> = {
    ...
    'S.PHẨM CHÍNH': { border: 'border-teal-500', sub: 'bg-teal-50 dark:bg-teal-900/30' },
    'DT THỰC NGÀNH HÀNG': { border: 'border-purple-500', sub: 'bg-purple-50 dark:bg-purple-900/30' },
...
export const DEFAULT_WAREHOUSE_COLUMNS: WarehouseColumnConfig[] = [
    ...
    { id: 'hqqd', order: 3, isVisible: true, isCustom: false, metric: 'hieuQuaQD', mainHeader: 'Doanh Thu', subHeader: 'HQQĐ' },
    { id: 'traffic_th', order: 4, isVisible: true, isCustom: false, metric: 'slThuHo', mainHeader: 'TRAFFIC & TỶ LỆ TC/DT', subHeader: 'T.HỘ' },
    { id: 'traffic_tc', order: 5, isVisible: true, isCustom: false, metric: 'slTiepCan', mainHeader: 'TRAFFIC & TỶ LỆ TC/DT', subHeader: 'T.CẬN' },
    { id: 'traffic_tracham', order: 6, isVisible: true, isCustom: false, metric: 'traChamPercent', mainHeader: 'TRAFFIC & TỶ LỆ TC/DT', subHeader: 'T.CHẬM' },
    { id: 'spc_ce', order: 7, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'CE', metricType: 'quantity', mainHeader: 'S.PHẨM CHÍNH', subHeader: 'CE' },
    { id: 'spc_ict', order: 8, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'ICT', metricType: 'quantity', mainHeader: 'S.PHẨM CHÍNH', subHeader: 'ICT' },
    { id: 'bk_sim', order: 9, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Sim', metricType: 'quantity', mainHeader: 'SL BÁN KÈM', subHeader: 'SIM' },
    { id: 'bk_dh', order: 10, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Đồng hồ', metricType: 'quantity', mainHeader: 'SL BÁN KÈM', subHeader: 'Đ.HỒ TT' },
    { id: 'bk_smw', order: 11, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Wearable', metricType: 'quantity', mainHeader: 'SL BÁN KÈM', subHeader: 'SMW' },
    { id: 'dthh_bh', order: 12, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Bảo hiểm', metricType: 'revenue', mainHeader: 'DT THỰC NGÀNH HÀNG', subHeader: 'B.HIỂM' },
    { id: 'dthh_pk', order: 13, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Phụ kiện', metricType: 'revenue', mainHeader: 'DT THỰC NGÀNH HÀNG', subHeader: 'P.KIỆN' },
    { id: 'dthh_dgd', order: 14, isVisible: true, isCustom: false, categoryType: 'industry', categoryName: 'Gia dụng', metricType: 'revenue', mainHeader: 'DT THỰC NGÀNH HÀNG', subHeader: 'ĐGD' },
];
